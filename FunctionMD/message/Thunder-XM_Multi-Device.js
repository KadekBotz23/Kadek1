...
let fkontak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '62881038186826-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `Thunder-Multi`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;rifza;;;\nFN:rifza\nitem1.TEL;waid=62881038186826:62881038186826\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}               
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  setTimeout( () => {
  reply(`@${m.sender.split("@")[0]} Mulai menambang⛏️, `)     
  }, 1500)
   ...
   let button = [{
     index: 1, 
      urlButton: {
       ...
       url: 'https://github.com/KadekBotz23'
       } 
     },     
     {
     index: 2, 
   ...
   let buttonss = [{
     ...
     },     
     {
      index: 1, 
       ...
       url: 'https://www.instagram.com/kadekdimas._'
       }
       }, 
       {
       index: 1, 
